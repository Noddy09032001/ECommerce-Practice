...
export default function ProductCard({ product, onSelect }: Props) {
  ...
  const defaultImage = "https://images.unsplash.com/photo-1606220945770-b5b6c2c55bf1";

  const cheapestSeller = [...product.merchants].sort(
        ...
        <div className="mt-5 flex justify-between items-center">
          <div>
            ...
            <h3 className="text-2xl font-bold text-foreground">
              ₹{cheapestSeller.finalAmount.toLocaleString()}
            </h3>
          </div>
